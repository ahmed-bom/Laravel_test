  ...
  @keyframes form_div {
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
            <div id="icon">
                <x-application-logo class="w-[100px] h-20 fill-current text-gray-500" />
            </div>
            <div class="w-full flex justify-center mt-6">
                <div id="register"  class="text-lg font-medium text-gray-200">
                    {{$hed_register}}
                    <div id="Form_div" class="w-[350px] sm:max-w-md px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden rounded-b-[25px] rounded-tr-[25px]">
                        {{ $slot_register }}
                    </div>
                </div>
                <div id="login" class="text-lg font-medium text-gray-200">
                    {{$hed_login}}
                    <div  class="w-[350px] sm:max-w-md px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden rounded-b-[25px] rounded-tr-[25px]">
                        {{ $slot_login}}
                    </div>
                </div>
            </div>
